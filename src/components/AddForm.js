...
import { addsErrorMsg, addingSmurf } from "../actions";
...
const AddForm = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (state.name === "" || state.position === "" || state.nickname === "") {
      props.addsErrorMsg("Name, position and nickname fields are required.");
    } else {
      props.addingSmurf(state);
...
export default connect(mapStateToProps, { addsErrorMsg, addingSmurf })(AddForm);
